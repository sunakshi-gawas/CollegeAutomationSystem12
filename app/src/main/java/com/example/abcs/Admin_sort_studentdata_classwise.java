...
public class Admin_sort_studentdata_classwise extends AppCompatActivity {
    Button _1,_2,_3,_4;
    TextView comp, it,entc,cvil,mech;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_admin_sort_studentdata_classwise);
        ...
        _1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(Admin_sort_studentdata_classwise.this,Admin_asper_dept_class.class);
